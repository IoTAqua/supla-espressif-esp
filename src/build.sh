...
mkdir -p bin
cp ${SDK_PATH}/bin/boot_v1.2.bin bin/
cp ${SDK_PATH}/bin/boot_v1.6.bin bin/
cp ${SDK_PATH}/bin/boot_v1.7.bin bin/
cp ${SDK_PATH}/bin/esp_init_data_default_v05.bin bin/
cp ${SDK_PATH}/bin/esp_init_data_default_v08.bin bin/
cp ${SDK_PATH}/bin/blank.bin bin/
make clean
